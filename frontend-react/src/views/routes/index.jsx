...
import SupplierEdit from "../admin/supplier/edit";
import SupplierCreate from "../admin/supplier/create";
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route
        path="/admin/barang/"
        element={
          isAuthenticated ? <BarangIndex /> : <Navigate to={"/login"} replace />
        }
      ></Route>
      <Route
      ...
      <Route
        ...
        element={
          isAuthenticated ? <BarangEdit /> : <Navigate to={"/login"} replace />
        }
      ></Route>
